...
export default function LectureDetail({
  ...
  params: { lectureName: string };
}) {
  const decodedLectureName = decodeURIComponent(params.lectureName); // 강의 이름을 토대로 강의 데이터 가져옴
  return (
      ...
      <div className="p-4">
        ...
        <div>
          ...
          <p>
            ...
            점수 달성을 위한 습관을 기르는 과정입니다. 왕초보부터 중급자까지, 기초
            개념부터 실전 문제풀이까지 단계별로 학습하도록 구성되어 있으며, 매일
            정해진 분량만 따라와도 자연스럽게 실력이 쌓입니다. 100일 후에는,
            당신도 “토익 점수 200점 이상 상승”의 주인공이 될 수 있습니다!
          </p>
        </div>
