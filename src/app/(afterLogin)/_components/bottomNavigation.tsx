...
export default function BottomNavigation() {
  ...
  return (
    <div className="fixed bottom-0 w-96  bg-white flex flex-row items-center justify-between px-4 py-2.5 border-t border-[#F2F2F7]">
      <Link
        key="main"
        href="/"
      ...
      >
        <SearchIcon fill={pathname === "/search" || pathname === "/results" ? "#F6BF53" : "#737373"} />
        <span>강의찾기</span>
      </Link>
